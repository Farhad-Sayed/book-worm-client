...
import googleIcon from '../../images/icons8-google-50.png'
import './LogIn.css';
    ...
    <div className="main">
      <div className="signInArea">
        <div className="signIn">
          ...
          {newUser ? (
            <label htmlFor="newUser">
              Already hanve an account? Login (check box)
            </label>
          ) : (
            <label htmlFor="newUser">
              Don't have an account? Create (check box)
            </label>
          )}{" "}
          <br />
          {/* Without checkbox */}
        ...
        <button className="google" onClick={handleGoogleSignIn}>
          <img
            style={{ height: "25px", marginLeft: "30px", marginRight: "100px" }}
            src={googleIcon}
            alt=""
          />
